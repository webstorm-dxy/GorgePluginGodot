...
{
public partial class ElementLinePoint : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("ElementLinePoint", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.ElementLinePoint.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 3,
...
{
global::Gorge.Native.GorgeFramework.ElementLinePoint ElementLinePoint;
if(gorgeObject is global::Gorge.Native.GorgeFramework.ElementLinePoint)
{
ElementLinePoint = (global::Gorge.Native.GorgeFramework.ElementLinePoint) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
ElementLinePoint = (global::Gorge.Native.GorgeFramework.ElementLinePoint) u.NativeObject;
}
else
{
...
{
return global::Gorge.Native.GorgeFramework.ElementLinePoint.ConstructInstance(injector, InvokeParameterPool.Float[0], InvokeParameterPool.Float[1], InvokeParameterPool.Float[2]);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.ElementLinePoint.Class.Declaration;
public override GorgeObject Instantiate(int constructorIndex, params object[] args)
{
return constructorIndex switch
{
0 => ConstructInstance(this, (float)args[0], (float)args[1], (float)args[2]),
...
{
var injector = new global::Gorge.Native.GorgeFramework.ElementLinePoint.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.ElementLinePoint.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.ElementLinePoint FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.ElementLinePoint) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.ElementLinePoint) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.ElementLinePoint ConstructInstance(Injector injector, float time, float position, float width)
{
return new global::Gorge.Native.GorgeFramework.ElementLinePoint(injector, time, position, width);
}
/// <summary>
...
{
this.time = InitializeField_time();this.position = InitializeField_position();this.width = InitializeField_width();}
private static partial float InitializeField_time();private static partial float InitializeField_position();private static partial float InitializeField_width();public override int GetIntField(int fieldIndex)
{
