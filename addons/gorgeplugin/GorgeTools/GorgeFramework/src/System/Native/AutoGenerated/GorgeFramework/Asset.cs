...
{
public partial class Asset : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("Asset", "GorgeFramework", new GorgeType[]{});
...
metadata: global::Gorge.Native.GorgeFramework.Asset.InjectorFieldMetadata_name()
),
},
annotations: global::Gorge.Native.GorgeFramework.Asset.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.Asset Asset;
if(gorgeObject is global::Gorge.Native.GorgeFramework.Asset)
{
Asset = (global::Gorge.Native.GorgeFramework.Asset) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
Asset = (global::Gorge.Native.GorgeFramework.Asset) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.BoolReturn = Asset.LoadAsset();
break;
default:
...
{
return global::Gorge.Native.GorgeFramework.Asset.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.Asset.Class.Declaration;
...
private Tuple<string, bool> _name = new(default, true);
public string name
{
get => _name.Item1;
set => _name = new Tuple<string, bool>(value,false);
}
...
{
case 0:
_name = new Tuple<string, bool>(value, false);
return;
default:
...
{
case 0:
_name = new Tuple<string, bool>(default, true);
return;
default:
...
{
var injector = new global::Gorge.Native.GorgeFramework.Asset.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.Asset.SpecificInjector toInjector)
{
base.CloneTo(toInjector);
toInjector._name = _name;
}
}
/// <summary>
/// 静态单例
...
public new static global::Gorge.Native.GorgeFramework.Asset FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.Asset) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.Asset) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.Asset ConstructInstance(Injector injector)
{
return new global::Gorge.Native.GorgeFramework.Asset(injector);
}
/// <summary>
...
if (injector.GetInjectorStringDefault(0))
{
throw new Exception($"GorgeFramework.Asset类Injector的name字段没有设置，且没有默认值");
}
else
{
injector_name = injector.GetInjectorString(0);
}
this.name = InitializeField_name(injector_name);}
private static partial string InitializeField_name(string name);private static partial Dictionary<string, Metadata> InjectorFieldMetadata_name();public override int GetIntField(int fieldIndex)
{
