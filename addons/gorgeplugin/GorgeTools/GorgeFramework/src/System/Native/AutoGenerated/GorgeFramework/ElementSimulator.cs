...
{
public partial class ElementSimulator : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("ElementSimulator", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.ElementSimulator.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.ElementSimulator ElementSimulator;
if(gorgeObject is global::Gorge.Native.GorgeFramework.ElementSimulator)
{
ElementSimulator = (global::Gorge.Native.GorgeFramework.ElementSimulator) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
ElementSimulator = (global::Gorge.Native.GorgeFramework.ElementSimulator) u.NativeObject;
}
else
{
...
{
return global::Gorge.Native.GorgeFramework.ElementSimulator.ConstructInstance(injector, global::Gorge.Native.Gorge.ObjectArray.FromGorgeObject(InvokeParameterPool.Object[0]));
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.ElementSimulator.Class.Declaration;
public override GorgeObject Instantiate(int constructorIndex, params object[] args)
{
return constructorIndex switch
{
0 => ConstructInstance(this, global::Gorge.Native.Gorge.ObjectArray.FromGorgeObject((GorgeObject)args[0])),
...
{
var injector = new global::Gorge.Native.GorgeFramework.ElementSimulator.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.ElementSimulator.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.ElementSimulator FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.ElementSimulator) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.ElementSimulator) gorgeObject;
}
...
/// 索引为object:0
/// </summary>
public global::Gorge.Native.Gorge.ObjectArray transformers;
/// <summary>
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.ElementSimulator ConstructInstance(Injector injector, global::Gorge.Native.Gorge.ObjectArray transformers)
{
return new global::Gorge.Native.GorgeFramework.ElementSimulator(injector, transformers);
}
/// <summary>
...
{
this.transformers = InitializeField_transformers();}
private static partial global::Gorge.Native.Gorge.ObjectArray InitializeField_transformers();public override int GetIntField(int fieldIndex)
{
...
{
case 0:
this.transformers = (global::Gorge.Native.Gorge.ObjectArray)value;
return;
default:
