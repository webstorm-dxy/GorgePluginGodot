...
{
public partial class Audio : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("Audio", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.Audio.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.Audio Audio;
if(gorgeObject is global::Gorge.Native.GorgeFramework.Audio)
{
Audio = (global::Gorge.Native.GorgeFramework.Audio) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
Audio = (global::Gorge.Native.GorgeFramework.Audio) u.NativeObject;
}
else
{
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.Audio.Class.Declaration;
...
{
var injector = new global::Gorge.Native.GorgeFramework.Audio.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.Audio.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.Audio FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.Audio) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.Audio) gorgeObject;
}
