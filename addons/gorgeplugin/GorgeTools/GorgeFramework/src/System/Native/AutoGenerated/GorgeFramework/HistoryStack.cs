...
{
public partial class HistoryStack : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("HistoryStack", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.HistoryStack.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.HistoryStack HistoryStack;
if(gorgeObject is global::Gorge.Native.GorgeFramework.HistoryStack)
{
HistoryStack = (global::Gorge.Native.GorgeFramework.HistoryStack) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
HistoryStack = (global::Gorge.Native.GorgeFramework.HistoryStack) u.NativeObject;
}
else
{
...
{
return global::Gorge.Native.GorgeFramework.HistoryStack.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.HistoryStack.Class.Declaration;
...
{
var injector = new global::Gorge.Native.GorgeFramework.HistoryStack.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.HistoryStack.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.HistoryStack FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.HistoryStack) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.HistoryStack) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.HistoryStack ConstructInstance(Injector injector)
{
return new global::Gorge.Native.GorgeFramework.HistoryStack(injector);
}
/// <summary>
