...
{
public partial class TimeItem : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("TimeItem", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.TimeItem.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.TimeItem TimeItem;
if(gorgeObject is global::Gorge.Native.GorgeFramework.TimeItem)
{
TimeItem = (global::Gorge.Native.GorgeFramework.TimeItem) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
TimeItem = (global::Gorge.Native.GorgeFramework.TimeItem) u.NativeObject;
}
else
{
...
{
var instance = ConstructInstance(injector, (GorgeDelegate)InvokeParameterPool.Object[0], InvokeParameterPool.Bool[0], InvokeParameterPool.String[0]);
...
{
return global::Gorge.Native.GorgeFramework.TimeItem.ConstructInstance(injector, (GorgeDelegate)InvokeParameterPool.Object[0], InvokeParameterPool.Bool[0], InvokeParameterPool.String[0]);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.TimeItem.Class.Declaration;
public override GorgeObject Instantiate(int constructorIndex, params object[] args)
{
return constructorIndex switch
{
0 => ConstructInstance(this, (GorgeDelegate)args[0], (bool)args[1], (string)args[2]),
...
{
var injector = new global::Gorge.Native.GorgeFramework.TimeItem.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.TimeItem.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.TimeItem FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.TimeItem) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.TimeItem) gorgeObject;
}
...
/// 索引为object:0
/// </summary>
public GorgeDelegate time;
/// <summary>
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.TimeItem ConstructInstance(Injector injector, GorgeDelegate time, bool accept, string respondMode)
{
return new global::Gorge.Native.GorgeFramework.TimeItem(injector, time, accept, respondMode);
}
/// <summary>
...
{
this.accept = InitializeField_accept();this.respondMode = InitializeField_respondMode();this.time = InitializeField_time();}
private static partial bool InitializeField_accept();private static partial string InitializeField_respondMode();private static partial GorgeDelegate InitializeField_time();public override int GetIntField(int fieldIndex)
{
