...
{
public partial class Priority : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("Priority", "GorgeFramework", new GorgeType[]{});
...
id: 0,
name: "getPriority",
type: GorgeType.Delegate(GorgeType.Float,global::Gorge.Native.GorgeFramework.ISignal.Interface.Type),
...
annotations: global::Gorge.Native.GorgeFramework.Priority.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.Priority Priority;
if(gorgeObject is global::Gorge.Native.GorgeFramework.Priority)
{
Priority = (global::Gorge.Native.GorgeFramework.Priority) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
Priority = (global::Gorge.Native.GorgeFramework.Priority) u.NativeObject;
}
else
{
...
{
var instance = ConstructInstance(injector, (GorgeDelegate)InvokeParameterPool.Object[0]);
...
{
return global::Gorge.Native.GorgeFramework.Priority.ConstructInstance(injector, (GorgeDelegate)InvokeParameterPool.Object[0]);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.Priority.Class.Declaration;
public override GorgeObject Instantiate(int constructorIndex, params object[] args)
{
return constructorIndex switch
{
0 => ConstructInstance(this, (GorgeDelegate)args[0]),
...
{
var injector = new global::Gorge.Native.GorgeFramework.Priority.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.Priority.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.Priority FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.Priority) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.Priority) gorgeObject;
}
...
/// 索引为object:0
/// </summary>
public GorgeDelegate getPriority;
/// <summary>
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.Priority ConstructInstance(Injector injector, GorgeDelegate getPriority)
{
return new global::Gorge.Native.GorgeFramework.Priority(injector, getPriority);
}
/// <summary>
...
{
this.getPriority = InitializeField_getPriority();}
private static partial GorgeDelegate InitializeField_getPriority();public override int GetIntField(int fieldIndex)
{
...
{
case 0:
this.getPriority = (GorgeDelegate)value;
return;
default:
