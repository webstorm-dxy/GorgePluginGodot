...
{
public partial class AudioAsset : global::Gorge.Native.GorgeFramework.Asset
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("AudioAsset", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.AudioAsset.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.AudioAsset AudioAsset;
if(gorgeObject is global::Gorge.Native.GorgeFramework.AudioAsset)
{
AudioAsset = (global::Gorge.Native.GorgeFramework.AudioAsset) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
AudioAsset = (global::Gorge.Native.GorgeFramework.AudioAsset) u.NativeObject;
}
else
{
...
{
case 1:
InvokeParameterPool.ObjectReturn = AudioAsset.GetAsset();
break;
case 0:
case 2:
InvokeParameterPool.BoolReturn = AudioAsset.LoadAsset();
break;
default:
...
{
return global::Gorge.Native.GorgeFramework.AudioAsset.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.AudioAsset.Class.Declaration;
...
{
var injector = new global::Gorge.Native.GorgeFramework.AudioAsset.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.AudioAsset.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.AudioAsset FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.AudioAsset) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.AudioAsset) gorgeObject;
}
...
/// 1号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.AudioAsset ConstructInstance(Injector injector)
{
return new global::Gorge.Native.GorgeFramework.AudioAsset(injector);
}
/// <summary>
...
/// </summary>
/// <returns></returns>
public virtual partial global::Gorge.Native.GorgeFramework.Audio GetAsset();
/// <summary>
/// 2号方法
/// </summary>
/// <returns></returns>
