...
{
public partial class ElementLine : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("ElementLine", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.ElementLine.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.ElementLine ElementLine;
if(gorgeObject is global::Gorge.Native.GorgeFramework.ElementLine)
{
ElementLine = (global::Gorge.Native.GorgeFramework.ElementLine) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
ElementLine = (global::Gorge.Native.GorgeFramework.ElementLine) u.NativeObject;
}
else
{
...
{
var instance = ConstructInstance(injector, global::Gorge.Native.GorgeFramework.ColorArgb.FromGorgeObject(InvokeParameterPool.Object[0]), global::Gorge.Native.Gorge.ObjectArray.FromGorgeObject(InvokeParameterPool.Object[1]));
...
{
return global::Gorge.Native.GorgeFramework.ElementLine.ConstructInstance(injector, global::Gorge.Native.GorgeFramework.ColorArgb.FromGorgeObject(InvokeParameterPool.Object[0]), global::Gorge.Native.Gorge.ObjectArray.FromGorgeObject(InvokeParameterPool.Object[1]));
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.ElementLine.Class.Declaration;
public override GorgeObject Instantiate(int constructorIndex, params object[] args)
{
return constructorIndex switch
{
0 => ConstructInstance(this, global::Gorge.Native.GorgeFramework.ColorArgb.FromGorgeObject((GorgeObject)args[0]), global::Gorge.Native.Gorge.ObjectArray.FromGorgeObject((GorgeObject)args[1])),
...
{
var injector = new global::Gorge.Native.GorgeFramework.ElementLine.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.ElementLine.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.ElementLine FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.ElementLine) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.ElementLine) gorgeObject;
}
...
/// 索引为object:1
/// </summary>
public global::Gorge.Native.Gorge.ObjectArray points;
/// <summary>
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.ElementLine ConstructInstance(Injector injector, global::Gorge.Native.GorgeFramework.ColorArgb color, global::Gorge.Native.Gorge.ObjectArray points)
{
return new global::Gorge.Native.GorgeFramework.ElementLine(injector, color, points);
}
/// <summary>
...
{
this.color = InitializeField_color();this.points = InitializeField_points();}
private static partial global::Gorge.Native.GorgeFramework.ColorArgb InitializeField_color();private static partial global::Gorge.Native.Gorge.ObjectArray InitializeField_points();public override int GetIntField(int fieldIndex)
{
...
return;
case 1:
this.points = (global::Gorge.Native.Gorge.ObjectArray)value;
return;
default:
