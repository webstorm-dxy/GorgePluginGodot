...
{
public partial class SignalTsiga : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("SignalTsiga", "GorgeFramework", new GorgeType[]{});
...
id: 0,
name: "note",
type: global::Gorge.Native.GorgeFramework.Note.Implementation.Type(),
index: 0
),
new ParameterInformation(
id: 1,
name: "timeStack",
type: global::Gorge.Native.GorgeFramework.TimeStack.Implementation.Type(),
index: 1
),
new ParameterInformation(
id: 2,
name: "inputGraph",
type: global::Gorge.Native.GorgeFramework.InputGraph.Implementation.Type(),
index: 2
),
new ParameterInformation(
id: 3,
...
annotations: global::Gorge.Native.GorgeFramework.SignalTsiga.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.SignalTsiga SignalTsiga;
if(gorgeObject is global::Gorge.Native.GorgeFramework.SignalTsiga)
{
SignalTsiga = (global::Gorge.Native.GorgeFramework.SignalTsiga) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
SignalTsiga = (global::Gorge.Native.GorgeFramework.SignalTsiga) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.StringReturn = SignalTsiga.GetState();
break;
default:
...
{
var instance = ConstructInstance(injector, global::Gorge.Native.GorgeFramework.Note.FromGorgeObject(InvokeParameterPool.Object[0]), global::Gorge.Native.GorgeFramework.TimeStack.FromGorgeObject(InvokeParameterPool.Object[1]), global::Gorge.Native.GorgeFramework.InputGraph.FromGorgeObject(InvokeParameterPool.Object[2]), global::Gorge.Native.GorgeFramework.HistoryStack.FromGorgeObject(InvokeParameterPool.Object[3]));
...
{
return global::Gorge.Native.GorgeFramework.SignalTsiga.ConstructInstance(injector, global::Gorge.Native.GorgeFramework.Note.FromGorgeObject(InvokeParameterPool.Object[0]), global::Gorge.Native.GorgeFramework.TimeStack.FromGorgeObject(InvokeParameterPool.Object[1]), global::Gorge.Native.GorgeFramework.InputGraph.FromGorgeObject(InvokeParameterPool.Object[2]), global::Gorge.Native.GorgeFramework.HistoryStack.FromGorgeObject(InvokeParameterPool.Object[3]));
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.SignalTsiga.Class.Declaration;
public override GorgeObject Instantiate(int constructorIndex, params object[] args)
{
return constructorIndex switch
{
0 => ConstructInstance(this, global::Gorge.Native.GorgeFramework.Note.FromGorgeObject((GorgeObject)args[0]), global::Gorge.Native.GorgeFramework.TimeStack.FromGorgeObject((GorgeObject)args[1]), global::Gorge.Native.GorgeFramework.InputGraph.FromGorgeObject((GorgeObject)args[2]), global::Gorge.Native.GorgeFramework.HistoryStack.FromGorgeObject((GorgeObject)args[3])),
...
{
var injector = new global::Gorge.Native.GorgeFramework.SignalTsiga.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.SignalTsiga.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.SignalTsiga FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.SignalTsiga) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.SignalTsiga) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.SignalTsiga ConstructInstance(Injector injector, global::Gorge.Native.GorgeFramework.Note note, global::Gorge.Native.GorgeFramework.TimeStack timeStack, global::Gorge.Native.GorgeFramework.InputGraph inputGraph, global::Gorge.Native.GorgeFramework.HistoryStack historyStack)
{
return new global::Gorge.Native.GorgeFramework.SignalTsiga(injector, note, timeStack, inputGraph, historyStack);
}
/// <summary>
