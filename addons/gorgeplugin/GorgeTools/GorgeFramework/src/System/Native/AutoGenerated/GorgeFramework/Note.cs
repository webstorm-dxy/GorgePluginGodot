...
{
public partial class Note : global::Gorge.Native.GorgeFramework.Element
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("Note", "GorgeFramework", new GorgeType[]{});
public override GorgeClass SuperClass { get; } = global::Gorge.Native.GorgeFramework.Element.Class;
...
type: Type(),
isNative: true,
superClass: global::Gorge.Native.GorgeFramework.Element.Class.Declaration,
...
id: 3,
name: "automaton",
type: global::Gorge.Native.GorgeFramework.SignalTsiga.Implementation.Type(),
...
annotations: global::Gorge.Native.GorgeFramework.Note.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.Note Note;
if(gorgeObject is global::Gorge.Native.GorgeFramework.Note)
{
Note = (global::Gorge.Native.GorgeFramework.Note) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
Note = (global::Gorge.Native.GorgeFramework.Note) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.ObjectReturn = Note.DoRespond(InvokeParameterPool.String[0], InvokeParameterPool.Float[0]);
break;
default:
global::Gorge.Native.GorgeFramework.Element.Class.InvokeMethod(gorgeObject, methodId);
break;
}
}
...
{
default:
global::Gorge.Native.GorgeFramework.Element.Class.InvokeStaticMethod(methodId);
break;
}
}
...
{
return global::Gorge.Native.GorgeFramework.Note.ConstructInstance(injector);
}
break;
default:
...
public new class SpecificInjector : global::Gorge.Native.GorgeFramework.Element.SpecificInjector
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.Note.Class.Declaration;
...
{
var injector = new global::Gorge.Native.GorgeFramework.Note.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.Note.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.Note FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.Note) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.Note) gorgeObject;
}
...
/// 索引为object:3
/// </summary>
public global::Gorge.Native.GorgeFramework.SignalTsiga automaton;
/// <summary>
/// 1号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.Note ConstructInstance(Injector injector)
{
return new global::Gorge.Native.GorgeFramework.Note(injector);
}
/// <summary>
...
{
this.automaton = InitializeField_automaton();}
private static partial global::Gorge.Native.GorgeFramework.SignalTsiga InitializeField_automaton();public override int GetIntField(int fieldIndex)
{
...
{
case 3:
this.automaton = (global::Gorge.Native.GorgeFramework.SignalTsiga)value;
return;
default:
...
/// </summary>
/// <returns></returns>
public virtual partial global::Gorge.Native.Gorge.ObjectArray DoRespond(string respondMode, float respondChartTime);
