...
{
public partial class DeriveElementCommand : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("DeriveElementCommand", "GorgeFramework", new GorgeType[]{});
...
{
global::Gorge.Native.GorgeFramework.IAutomatonCommand.Interface
},
...
id: 0,
name: "element",
type: global::Gorge.Native.GorgeFramework.Element.Implementation.Type(),
annotations: new Annotation[]{},
index: 0
),
new FieldInformation(
id: 1,
name: "changeAutomaton",
type: GorgeType.Bool,
annotations: new Annotation[]{},
index: 0
),
...
annotations: global::Gorge.Native.GorgeFramework.DeriveElementCommand.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
{
"GorgeFramework.IAutomatonCommand",
new int[]
{
}
}
...
{
global::Gorge.Native.GorgeFramework.DeriveElementCommand DeriveElementCommand;
if(gorgeObject is global::Gorge.Native.GorgeFramework.DeriveElementCommand)
{
DeriveElementCommand = (global::Gorge.Native.GorgeFramework.DeriveElementCommand) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
DeriveElementCommand = (global::Gorge.Native.GorgeFramework.DeriveElementCommand) u.NativeObject;
}
else
{
...
{
var instance = ConstructInstance(injector, global::Gorge.Native.GorgeFramework.Element.FromGorgeObject(InvokeParameterPool.Object[0]), InvokeParameterPool.Bool[0]);
...
{
return global::Gorge.Native.GorgeFramework.DeriveElementCommand.ConstructInstance(injector, global::Gorge.Native.GorgeFramework.Element.FromGorgeObject(InvokeParameterPool.Object[0]), InvokeParameterPool.Bool[0]);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.DeriveElementCommand.Class.Declaration;
public override GorgeObject Instantiate(int constructorIndex, params object[] args)
{
return constructorIndex switch
{
0 => ConstructInstance(this, global::Gorge.Native.GorgeFramework.Element.FromGorgeObject((GorgeObject)args[0]), (bool)args[1]),
...
{
var injector = new global::Gorge.Native.GorgeFramework.DeriveElementCommand.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.DeriveElementCommand.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.DeriveElementCommand FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.DeriveElementCommand) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.DeriveElementCommand) gorgeObject;
}
...
/// 索引为object:0
/// </summary>
public global::Gorge.Native.GorgeFramework.Element element;
/// <summary>
/// 1号字段
/// 索引为bool:0
/// </summary>
public bool changeAutomaton;
/// <summary>
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.DeriveElementCommand ConstructInstance(Injector injector, global::Gorge.Native.GorgeFramework.Element element, bool changeAutomaton)
{
return new global::Gorge.Native.GorgeFramework.DeriveElementCommand(injector, element, changeAutomaton);
}
/// <summary>
...
{
this.element = InitializeField_element();this.changeAutomaton = InitializeField_changeAutomaton();}
private static partial global::Gorge.Native.GorgeFramework.Element InitializeField_element();private static partial bool InitializeField_changeAutomaton();public override int GetIntField(int fieldIndex)
{
...
{
case 0:
this.element = (global::Gorge.Native.GorgeFramework.Element)value;
return;
default:
