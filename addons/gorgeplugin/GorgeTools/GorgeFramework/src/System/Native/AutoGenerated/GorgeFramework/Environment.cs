...
{
public partial class Environment : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("Environment", "GorgeFramework", new GorgeType[]{});
...
id: 0,
name: "GetAssetByName",
returnType: global::Gorge.Native.GorgeFramework.Asset.Implementation.Type(),
...
id: 1,
name: "FindAliveLane",
returnType: global::Gorge.Native.GorgeFramework.Element.Implementation.Type(),
parameters: new ParameterInformation[]
{
new ParameterInformation(
id: 0,
...
id: 0,
name: "result",
type: global::Gorge.Native.GorgeFramework.RespondResult.Enum.Type,
index: 0
),
},
annotations: new Annotation[]{}
...
annotations: global::Gorge.Native.GorgeFramework.Environment.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.Environment Environment;
if(gorgeObject is global::Gorge.Native.GorgeFramework.Environment)
{
Environment = (global::Gorge.Native.GorgeFramework.Environment) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
Environment = (global::Gorge.Native.GorgeFramework.Environment) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.ObjectReturn = GorgeFramework.Environment.GetAssetByName(InvokeParameterPool.String[0]);
break;
case 1:
InvokeParameterPool.ObjectReturn = GorgeFramework.Environment.FindAliveLane(InvokeParameterPool.String[0], InvokeParameterPool.String[1]);
break;
case 2:
InvokeParameterPool.ObjectReturn = GorgeFramework.Environment.ScreenToWorldPoint((global::Gorge.Native.GorgeFramework.Vector3)InvokeParameterPool.Object[0]);
break;
case 3:
GorgeFramework.Environment.Scoring(InvokeParameterPool.Int[0]);
break;
case 4:
GorgeFramework.Environment.PlayRespondEffect(InvokeParameterPool.String[0]);
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.Environment.Class.Declaration;
...
{
var injector = new global::Gorge.Native.GorgeFramework.Environment.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.Environment.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.Environment FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.Environment) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.Environment) gorgeObject;
}
...
/// </summary>
/// <returns></returns>
public static partial global::Gorge.Native.GorgeFramework.Asset GetAssetByName(string assetName);
/// <summary>
/// 1号方法
/// </summary>
/// <returns></returns>
public static partial global::Gorge.Native.GorgeFramework.Element FindAliveLane(string typeName, string laneName);
/// <summary>
/// 2号方法
/// </summary>
/// <returns></returns>
public static partial global::Gorge.Native.GorgeFramework.Vector3 ScreenToWorldPoint(global::Gorge.Native.GorgeFramework.Vector3 position);
/// <summary>
/// 3号方法
/// </summary>
/// <returns></returns>
