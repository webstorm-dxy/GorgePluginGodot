...
{
public partial class Graph : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("Graph", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.Graph.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 2,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.Graph Graph;
if(gorgeObject is global::Gorge.Native.GorgeFramework.Graph)
{
Graph = (global::Gorge.Native.GorgeFramework.Graph) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
Graph = (global::Gorge.Native.GorgeFramework.Graph) u.NativeObject;
}
else
{
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.Graph.Class.Declaration;
...
{
var injector = new global::Gorge.Native.GorgeFramework.Graph.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.Graph.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.Graph FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.Graph) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.Graph) gorgeObject;
}
...
{
this.width = InitializeField_width();this.height = InitializeField_height();}
private static partial int InitializeField_width();private static partial int InitializeField_height();public override int GetIntField(int fieldIndex)
{
