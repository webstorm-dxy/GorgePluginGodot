...
{
public partial class Node : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("Node", "GorgeFramework", new GorgeType[]{});
...
new FieldInformation(
id: 1,
name: "existenceReference",
type: global::Gorge.Native.GorgeFramework.Node.Implementation.Type(),
annotations: new Annotation[]{},
index: 0
),
new FieldInformation(
...
new MethodInformation(
id: 1,
name: "LocalPositionToGlobalPosition",
returnType: global::Gorge.Native.GorgeFramework.Vector3.Implementation.Type(),
parameters: new ParameterInformation[]
{
...
new MethodInformation(
id: 2,
name: "GlobalPositionToLocalPosition",
returnType: global::Gorge.Native.GorgeFramework.Vector3.Implementation.Type(),
parameters: new ParameterInformation[]
{
new ParameterInformation(
...
annotations: global::Gorge.Native.GorgeFramework.Node.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.Node Node;
if(gorgeObject is global::Gorge.Native.GorgeFramework.Node)
{
Node = (global::Gorge.Native.GorgeFramework.Node) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
Node = (global::Gorge.Native.GorgeFramework.Node) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.ObjectReturn = Node.GlobalPosition();
break;
case 1:
InvokeParameterPool.ObjectReturn = Node.LocalPositionToGlobalPosition((global::Gorge.Native.GorgeFramework.Vector3)InvokeParameterPool.Object[0]);
break;
case 2:
InvokeParameterPool.ObjectReturn = Node.GlobalPositionToLocalPosition((global::Gorge.Native.GorgeFramework.Vector3)InvokeParameterPool.Object[0]);
break;
default:
...
{
return global::Gorge.Native.GorgeFramework.Node.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.Node.Class.Declaration;
...
{
var injector = new global::Gorge.Native.GorgeFramework.Node.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.Node.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.Node FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.Node) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.Node) gorgeObject;
}
...
/// 索引为object:0
/// </summary>
public global::Gorge.Native.GorgeFramework.Node existenceReference;
/// <summary>
/// 2号字段
/// 索引为object:1
/// </summary>
public global::Gorge.Native.GorgeFramework.Vector3 position;
/// <summary>
/// 3号字段
/// 索引为object:2
/// </summary>
public global::Gorge.Native.GorgeFramework.Node positionReference;
/// <summary>
/// 4号字段
/// 索引为object:3
/// </summary>
public global::Gorge.Native.GorgeFramework.Vector3 rotation;
/// <summary>
/// 5号字段
/// 索引为object:4
/// </summary>
public global::Gorge.Native.GorgeFramework.Node rotationReference;
/// <summary>
/// 6号字段
/// 索引为object:5
/// </summary>
public global::Gorge.Native.GorgeFramework.Vector3 size;
/// <summary>
/// 7号字段
/// 索引为object:6
/// </summary>
public global::Gorge.Native.GorgeFramework.Node sizeReference;
/// <summary>
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.Node ConstructInstance(Injector injector)
{
return new global::Gorge.Native.GorgeFramework.Node(injector);
}
/// <summary>
...
{
this.alive = InitializeField_alive();this.existenceReference = InitializeField_existenceReference();this.position = InitializeField_position();this.positionReference = InitializeField_positionReference();this.rotation = InitializeField_rotation();this.rotationReference = InitializeField_rotationReference();this.size = InitializeField_size();this.sizeReference = InitializeField_sizeReference();}
private static partial bool InitializeField_alive();private static partial global::Gorge.Native.GorgeFramework.Node InitializeField_existenceReference();private static partial global::Gorge.Native.GorgeFramework.Vector3 InitializeField_position();private static partial global::Gorge.Native.GorgeFramework.Node InitializeField_positionReference();private static partial global::Gorge.Native.GorgeFramework.Vector3 InitializeField_rotation();private static partial global::Gorge.Native.GorgeFramework.Node InitializeField_rotationReference();private static partial global::Gorge.Native.GorgeFramework.Vector3 InitializeField_size();private static partial global::Gorge.Native.GorgeFramework.Node InitializeField_sizeReference();public override int GetIntField(int fieldIndex)
{
...
{
case 0:
this.existenceReference = (global::Gorge.Native.GorgeFramework.Node)value;
return;
case 1:
this.position = (global::Gorge.Native.GorgeFramework.Vector3)value;
return;
case 2:
this.positionReference = (global::Gorge.Native.GorgeFramework.Node)value;
return;
case 3:
this.rotation = (global::Gorge.Native.GorgeFramework.Vector3)value;
return;
case 4:
this.rotationReference = (global::Gorge.Native.GorgeFramework.Node)value;
return;
case 5:
this.size = (global::Gorge.Native.GorgeFramework.Vector3)value;
return;
case 6:
this.sizeReference = (global::Gorge.Native.GorgeFramework.Node)value;
return;
default:
...
/// </summary>
/// <returns></returns>
public virtual partial global::Gorge.Native.GorgeFramework.Vector3 GlobalPosition();
/// <summary>
/// 1号方法
/// </summary>
/// <returns></returns>
public virtual partial global::Gorge.Native.GorgeFramework.Vector3 LocalPositionToGlobalPosition(global::Gorge.Native.GorgeFramework.Vector3 position);
/// <summary>
/// 2号方法
/// </summary>
/// <returns></returns>
public virtual partial global::Gorge.Native.GorgeFramework.Vector3 GlobalPositionToLocalPosition(global::Gorge.Native.GorgeFramework.Vector3 position);
