...
{
public partial class ColorCurve : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("ColorCurve", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.ColorCurve.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.ColorCurve ColorCurve;
if(gorgeObject is global::Gorge.Native.GorgeFramework.ColorCurve)
{
ColorCurve = (global::Gorge.Native.GorgeFramework.ColorCurve) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
ColorCurve = (global::Gorge.Native.GorgeFramework.ColorCurve) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.ObjectReturn = ColorCurve.Evaluate(InvokeParameterPool.Float[0]);
break;
default:
...
{
return global::Gorge.Native.GorgeFramework.ColorCurve.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.ColorCurve.Class.Declaration;
...
{
var injector = new global::Gorge.Native.GorgeFramework.ColorCurve.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.ColorCurve.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.ColorCurve FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.ColorCurve) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.ColorCurve) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.ColorCurve ConstructInstance(Injector injector)
{
return new global::Gorge.Native.GorgeFramework.ColorCurve(injector);
}
/// <summary>
...
/// </summary>
/// <returns></returns>
public virtual partial global::Gorge.Native.GorgeFramework.ColorArgb Evaluate(float x);
