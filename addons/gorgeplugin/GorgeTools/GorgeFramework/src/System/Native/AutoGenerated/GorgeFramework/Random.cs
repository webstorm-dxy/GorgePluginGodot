...
{
public partial class Random : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("Random", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.Random.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.Random Random;
if(gorgeObject is global::Gorge.Native.GorgeFramework.Random)
{
Random = (global::Gorge.Native.GorgeFramework.Random) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
Random = (global::Gorge.Native.GorgeFramework.Random) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.ObjectReturn = GorgeFramework.Random.RandomNormalized();
break;
case 1:
InvokeParameterPool.FloatReturn = GorgeFramework.Random.RandomFloat(InvokeParameterPool.Float[0], InvokeParameterPool.Float[1]);
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.Random.Class.Declaration;
...
{
var injector = new global::Gorge.Native.GorgeFramework.Random.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.Random.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.Random FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.Random) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.Random) gorgeObject;
}
...
/// </summary>
/// <returns></returns>
public static partial global::Gorge.Native.GorgeFramework.Vector2 RandomNormalized();
/// <summary>
/// 1号方法
/// </summary>
/// <returns></returns>
