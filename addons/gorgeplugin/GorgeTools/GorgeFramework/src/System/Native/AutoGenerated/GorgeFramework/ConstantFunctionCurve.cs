...
{
public partial class ConstantFunctionCurve : global::Gorge.Native.GorgeFramework.FunctionCurve
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("ConstantFunctionCurve", "GorgeFramework", new GorgeType[]{});
...
index: 0,
defaultValueIndex: 0,
metadata: global::Gorge.Native.GorgeFramework.ConstantFunctionCurve.InjectorFieldMetadata_value()
),
},
annotations: global::Gorge.Native.GorgeFramework.ConstantFunctionCurve.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 1,
...
{
global::Gorge.Native.GorgeFramework.ConstantFunctionCurve ConstantFunctionCurve;
if(gorgeObject is global::Gorge.Native.GorgeFramework.ConstantFunctionCurve)
{
ConstantFunctionCurve = (global::Gorge.Native.GorgeFramework.ConstantFunctionCurve) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
ConstantFunctionCurve = (global::Gorge.Native.GorgeFramework.ConstantFunctionCurve) u.NativeObject;
}
else
{
...
case 0:
case 1:
InvokeParameterPool.FloatReturn = ConstantFunctionCurve.Evaluate(InvokeParameterPool.Float[0]);
break;
default:
...
{
return global::Gorge.Native.GorgeFramework.ConstantFunctionCurve.ConstructInstance(injector);
}
break;
case 2:
if (targetObject != null)
...
if (targetObject is CompiledGorgeObject u) // 外部继承本Native类
{
var instance = ConstructInstance(injector, InvokeParameterPool.Float[0]);
instance.OuterCompiledObject = u;
u.NativeObject = instance;
return targetObject;
}
...
{
return global::Gorge.Native.GorgeFramework.ConstantFunctionCurve.ConstructInstance(injector, InvokeParameterPool.Float[0]);
}
break;
default:
...
return defaultValueIndex switch
{
0 => InjectorFieldDefaultValue_value(),
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.ConstantFunctionCurve.Class.Declaration;
...
2 => ConstructInstance(this, (float)args[0]),
_ => throw new Exception($"Image类没有编号为{constructorIndex}的构造方法")
};
}
private Tuple<float, bool> _value = new(default, true);
public float value
{
get => _value.Item1;
set => _value = new Tuple<float, bool>(value,false);
}
...
{
case 0:
_value = new Tuple<float, bool>(value, false);
return;
default:
...
{
case 0:
_value = new Tuple<float, bool>(default, true);
return;
default:
...
{
var injector = new global::Gorge.Native.GorgeFramework.ConstantFunctionCurve.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.ConstantFunctionCurve.SpecificInjector toInjector)
{
base.CloneTo(toInjector);
toInjector._value = _value;
}
}
/// <summary>
/// 静态单例
...
public new static global::Gorge.Native.GorgeFramework.ConstantFunctionCurve FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.ConstantFunctionCurve) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.ConstantFunctionCurve) gorgeObject;
}
...
/// 1号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.ConstantFunctionCurve ConstructInstance(Injector injector)
{
return new global::Gorge.Native.GorgeFramework.ConstantFunctionCurve(injector);
}
/// <summary>
/// 2号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.ConstantFunctionCurve ConstructInstance(Injector injector, float value)
{
return new global::Gorge.Native.GorgeFramework.ConstantFunctionCurve(injector, value);
}
/// <summary>
...
{
float injector_value;
if (injector.GetInjectorFloatDefault(0))
{
injector_value = InjectorFieldDefaultValue_value();
}
else
{
injector_value = injector.GetInjectorFloat(0);
}
this.value = InitializeField_value(injector_value);}
private static partial float InitializeField_value(float value);private static partial Dictionary<string, Metadata> InjectorFieldMetadata_value();/// <summary>
/// Injector的value字段的默认值生成方法
/// </summary>
/// <returns>该字段的默认值</returns>
private static partial float InjectorFieldDefaultValue_value();public override int GetIntField(int fieldIndex)
{
