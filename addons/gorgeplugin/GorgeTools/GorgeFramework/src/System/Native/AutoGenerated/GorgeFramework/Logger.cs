...
{
public partial class Logger : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("Logger", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.Logger.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.Logger Logger;
if(gorgeObject is global::Gorge.Native.GorgeFramework.Logger)
{
Logger = (global::Gorge.Native.GorgeFramework.Logger) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
Logger = (global::Gorge.Native.GorgeFramework.Logger) u.NativeObject;
}
else
{
...
{
case 0:
GorgeFramework.Logger.Log(InvokeParameterPool.String[0]);
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.Logger.Class.Declaration;
...
{
var injector = new global::Gorge.Native.GorgeFramework.Logger.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.Logger.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.Logger FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.Logger) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.Logger) gorgeObject;
}
