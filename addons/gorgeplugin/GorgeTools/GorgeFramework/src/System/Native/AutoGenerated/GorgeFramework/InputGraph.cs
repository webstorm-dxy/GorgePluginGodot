...
{
public partial class InputGraph : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("InputGraph", "GorgeFramework", new GorgeType[]{});
...
id: 0,
name: "GoAcceptEdge",
returnType: global::Gorge.Native.GorgeFramework.InputGraphEdge.Implementation.Type(),
...
annotations: global::Gorge.Native.GorgeFramework.InputGraph.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.InputGraph InputGraph;
if(gorgeObject is global::Gorge.Native.GorgeFramework.InputGraph)
{
InputGraph = (global::Gorge.Native.GorgeFramework.InputGraph) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
InputGraph = (global::Gorge.Native.GorgeFramework.InputGraph) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.ObjectReturn = InputGraph.GoAcceptEdge(InvokeParameterPool.Float[0], (global::Gorge.Native.GorgeFramework.HistoryStack)InvokeParameterPool.Object[0]);
break;
case 1:
InvokeParameterPool.ObjectReturn = InputGraph.GoDenyEdge(InvokeParameterPool.Float[0], (global::Gorge.Native.GorgeFramework.HistoryStack)InvokeParameterPool.Object[0]);
break;
default:
...
{
var instance = ConstructInstance(injector, global::Gorge.Native.Gorge.ObjectArray.FromGorgeObject(InvokeParameterPool.Object[0]), InvokeParameterPool.Bool[0], InvokeParameterPool.Bool[1], InvokeParameterPool.Int[0], InvokeParameterPool.String[0]);
...
{
return global::Gorge.Native.GorgeFramework.InputGraph.ConstructInstance(injector, global::Gorge.Native.Gorge.ObjectArray.FromGorgeObject(InvokeParameterPool.Object[0]), InvokeParameterPool.Bool[0], InvokeParameterPool.Bool[1], InvokeParameterPool.Int[0], InvokeParameterPool.String[0]);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.InputGraph.Class.Declaration;
public override GorgeObject Instantiate(int constructorIndex, params object[] args)
{
return constructorIndex switch
{
0 => ConstructInstance(this, global::Gorge.Native.Gorge.ObjectArray.FromGorgeObject((GorgeObject)args[0]), (bool)args[1], (bool)args[2], (int)args[3], (string)args[4]),
...
{
var injector = new global::Gorge.Native.GorgeFramework.InputGraph.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.InputGraph.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.InputGraph FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.InputGraph) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.InputGraph) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.InputGraph ConstructInstance(Injector injector, global::Gorge.Native.Gorge.ObjectArray states, bool accept, bool stackRespond, int inputPointer, string exportState)
{
return new global::Gorge.Native.GorgeFramework.InputGraph(injector, states, accept, stackRespond, inputPointer, exportState);
}
/// <summary>
...
/// </summary>
/// <returns></returns>
public virtual partial global::Gorge.Native.GorgeFramework.InputGraphEdge GoAcceptEdge(float chartTime, global::Gorge.Native.GorgeFramework.HistoryStack historyStack);
/// <summary>
/// 1号方法
/// </summary>
/// <returns></returns>
public virtual partial global::Gorge.Native.GorgeFramework.InputGraphEdge GoDenyEdge(float chartTime, global::Gorge.Native.GorgeFramework.HistoryStack historyStack);
