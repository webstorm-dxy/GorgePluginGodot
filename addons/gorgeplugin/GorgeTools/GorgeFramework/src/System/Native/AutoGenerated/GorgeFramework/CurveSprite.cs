...
{
public partial class CurveSprite : global::Gorge.Native.GorgeFramework.Node
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("CurveSprite", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.CurveSprite.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.CurveSprite CurveSprite;
if(gorgeObject is global::Gorge.Native.GorgeFramework.CurveSprite)
{
CurveSprite = (global::Gorge.Native.GorgeFramework.CurveSprite) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
CurveSprite = (global::Gorge.Native.GorgeFramework.CurveSprite) u.NativeObject;
}
else
{
...
{
var instance = ConstructInstance(injector, global::Gorge.Native.Gorge.ObjectArray.FromGorgeObject(InvokeParameterPool.Object[0]));
...
{
return global::Gorge.Native.GorgeFramework.CurveSprite.ConstructInstance(injector, global::Gorge.Native.Gorge.ObjectArray.FromGorgeObject(InvokeParameterPool.Object[0]));
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.CurveSprite.Class.Declaration;
public override GorgeObject Instantiate(int constructorIndex, params object[] args)
{
return constructorIndex switch
{
1 => ConstructInstance(this, global::Gorge.Native.Gorge.ObjectArray.FromGorgeObject((GorgeObject)args[0])),
...
{
var injector = new global::Gorge.Native.GorgeFramework.CurveSprite.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.CurveSprite.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.CurveSprite FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.CurveSprite) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.CurveSprite) gorgeObject;
}
...
/// 1号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.CurveSprite ConstructInstance(Injector injector, global::Gorge.Native.Gorge.ObjectArray points)
{
return new global::Gorge.Native.GorgeFramework.CurveSprite(injector, points);
}
/// <summary>
...
{
this.points = InitializeField_points();this.color = InitializeField_color();}
private static partial global::Gorge.Native.Gorge.ObjectArray InitializeField_points();private static partial global::Gorge.Native.GorgeFramework.ColorArgb InitializeField_color();public override int GetIntField(int fieldIndex)
{
