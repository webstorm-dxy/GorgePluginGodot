...
{
public partial class FunctionCurve : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("FunctionCurve", "GorgeFramework", new GorgeType[]{});
...
annotations: global::Gorge.Native.GorgeFramework.FunctionCurve.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.FunctionCurve FunctionCurve;
if(gorgeObject is global::Gorge.Native.GorgeFramework.FunctionCurve)
{
FunctionCurve = (global::Gorge.Native.GorgeFramework.FunctionCurve) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
FunctionCurve = (global::Gorge.Native.GorgeFramework.FunctionCurve) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.FloatReturn = FunctionCurve.Evaluate(InvokeParameterPool.Float[0]);
break;
default:
...
{
return global::Gorge.Native.GorgeFramework.FunctionCurve.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.FunctionCurve.Class.Declaration;
...
{
var injector = new global::Gorge.Native.GorgeFramework.FunctionCurve.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.FunctionCurve.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.FunctionCurve FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.FunctionCurve) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.FunctionCurve) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.FunctionCurve ConstructInstance(Injector injector)
{
return new global::Gorge.Native.GorgeFramework.FunctionCurve(injector);
}
/// <summary>
