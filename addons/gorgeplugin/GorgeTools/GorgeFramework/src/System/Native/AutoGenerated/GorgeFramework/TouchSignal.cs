...
{
public partial class TouchSignal : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("TouchSignal", "GorgeFramework", new GorgeType[]{});
...
{
global::Gorge.Native.GorgeFramework.ISignal.Interface
},
...
annotations: global::Gorge.Native.GorgeFramework.TouchSignal.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 0,
floatCount: 0,
...
{
global::Gorge.Native.GorgeFramework.TouchSignal TouchSignal;
if(gorgeObject is global::Gorge.Native.GorgeFramework.TouchSignal)
{
TouchSignal = (global::Gorge.Native.GorgeFramework.TouchSignal) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
TouchSignal = (global::Gorge.Native.GorgeFramework.TouchSignal) u.NativeObject;
}
else
{
...
{
var instance = ConstructInstance(injector, InvokeParameterPool.Bool[0], global::Gorge.Native.GorgeFramework.Vector2.FromGorgeObject(InvokeParameterPool.Object[0]));
...
{
return global::Gorge.Native.GorgeFramework.TouchSignal.ConstructInstance(injector, InvokeParameterPool.Bool[0], global::Gorge.Native.GorgeFramework.Vector2.FromGorgeObject(InvokeParameterPool.Object[0]));
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.GorgeFramework.TouchSignal.Class.Declaration;
public override GorgeObject Instantiate(int constructorIndex, params object[] args)
{
return constructorIndex switch
{
0 => ConstructInstance(this, (bool)args[0], global::Gorge.Native.GorgeFramework.Vector2.FromGorgeObject((GorgeObject)args[1])),
...
{
var injector = new global::Gorge.Native.GorgeFramework.TouchSignal.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.GorgeFramework.TouchSignal.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.GorgeFramework.TouchSignal FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.GorgeFramework.TouchSignal) u.NativeObject;
}
return (global::Gorge.Native.GorgeFramework.TouchSignal) gorgeObject;
}
...
/// 索引为object:0
/// </summary>
public global::Gorge.Native.GorgeFramework.Vector2 position;
/// <summary>
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.GorgeFramework.TouchSignal ConstructInstance(Injector injector, bool isTouching, global::Gorge.Native.GorgeFramework.Vector2 position)
{
return new global::Gorge.Native.GorgeFramework.TouchSignal(injector, isTouching, position);
}
/// <summary>
...
{
this.isTouching = InitializeField_isTouching();this.position = InitializeField_position();}
private static partial bool InitializeField_isTouching();private static partial global::Gorge.Native.GorgeFramework.Vector2 InitializeField_position();public override int GetIntField(int fieldIndex)
{
...
{
case 0:
this.position = (global::Gorge.Native.GorgeFramework.Vector2)value;
return;
default:
