...
{
public partial class StringArray : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("StringArray", "Gorge", new GorgeType[]{});
...
metadata: global::Gorge.Native.Gorge.StringArray.InjectorFieldMetadata_length()
),
},
annotations: global::Gorge.Native.Gorge.StringArray.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 1,
floatCount: 0,
...
{
global::Gorge.Native.Gorge.StringArray StringArray;
if(gorgeObject is global::Gorge.Native.Gorge.StringArray)
{
StringArray = (global::Gorge.Native.Gorge.StringArray) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
StringArray = (global::Gorge.Native.Gorge.StringArray) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.StringReturn = StringArray.Get(InvokeParameterPool.Int[0]);
break;
case 1:
StringArray.Set(InvokeParameterPool.Int[0], InvokeParameterPool.String[0]);
break;
default:
...
{
return global::Gorge.Native.Gorge.StringArray.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.Gorge.StringArray.Class.Declaration;
...
{
var injector = new global::Gorge.Native.Gorge.StringArray.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.Gorge.StringArray.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.Gorge.StringArray FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.Gorge.StringArray) u.NativeObject;
}
return (global::Gorge.Native.Gorge.StringArray) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.Gorge.StringArray ConstructInstance(Injector injector)
{
return new global::Gorge.Native.Gorge.StringArray(injector);
}
/// <summary>
...
{
throw new Exception($"Gorge.StringArray类Injector的length字段没有设置，且没有默认值");
}
else
{
