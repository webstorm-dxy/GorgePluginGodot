...
{
public partial class BoolList : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("BoolList", "Gorge", new GorgeType[]{});
...
metadata: global::Gorge.Native.Gorge.BoolList.InjectorFieldMetadata_length()
),
},
annotations: global::Gorge.Native.Gorge.BoolList.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 1,
floatCount: 0,
...
{
global::Gorge.Native.Gorge.BoolList BoolList;
if(gorgeObject is global::Gorge.Native.Gorge.BoolList)
{
BoolList = (global::Gorge.Native.Gorge.BoolList) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
BoolList = (global::Gorge.Native.Gorge.BoolList) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.BoolReturn = BoolList.Get(InvokeParameterPool.Int[0]);
break;
case 1:
BoolList.Set(InvokeParameterPool.Int[0], InvokeParameterPool.Bool[0]);
break;
case 2:
BoolList.Add(InvokeParameterPool.Bool[0]);
break;
case 3:
BoolList.RemoveAt(InvokeParameterPool.Int[0]);
break;
default:
...
{
return global::Gorge.Native.Gorge.BoolList.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.Gorge.BoolList.Class.Declaration;
...
{
var injector = new global::Gorge.Native.Gorge.BoolList.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.Gorge.BoolList.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.Gorge.BoolList FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.Gorge.BoolList) u.NativeObject;
}
return (global::Gorge.Native.Gorge.BoolList) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.Gorge.BoolList ConstructInstance(Injector injector)
{
return new global::Gorge.Native.Gorge.BoolList(injector);
}
/// <summary>
...
{
throw new Exception($"Gorge.BoolList类Injector的length字段没有设置，且没有默认值");
}
else
{
