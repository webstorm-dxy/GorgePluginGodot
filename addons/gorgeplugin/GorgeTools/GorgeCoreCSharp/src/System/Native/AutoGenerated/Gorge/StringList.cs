...
{
public partial class StringList : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("StringList", "Gorge", new GorgeType[]{});
...
metadata: global::Gorge.Native.Gorge.StringList.InjectorFieldMetadata_length()
),
},
annotations: global::Gorge.Native.Gorge.StringList.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 1,
floatCount: 0,
...
{
global::Gorge.Native.Gorge.StringList StringList;
if(gorgeObject is global::Gorge.Native.Gorge.StringList)
{
StringList = (global::Gorge.Native.Gorge.StringList) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
StringList = (global::Gorge.Native.Gorge.StringList) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.StringReturn = StringList.Get(InvokeParameterPool.Int[0]);
break;
case 1:
StringList.Set(InvokeParameterPool.Int[0], InvokeParameterPool.String[0]);
break;
case 2:
StringList.Add(InvokeParameterPool.String[0]);
break;
case 3:
StringList.RemoveAt(InvokeParameterPool.Int[0]);
break;
default:
...
{
return global::Gorge.Native.Gorge.StringList.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.Gorge.StringList.Class.Declaration;
...
{
var injector = new global::Gorge.Native.Gorge.StringList.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.Gorge.StringList.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.Gorge.StringList FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.Gorge.StringList) u.NativeObject;
}
return (global::Gorge.Native.Gorge.StringList) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.Gorge.StringList ConstructInstance(Injector injector)
{
return new global::Gorge.Native.Gorge.StringList(injector);
}
/// <summary>
...
{
throw new Exception($"Gorge.StringList类Injector的length字段没有设置，且没有默认值");
}
else
{
