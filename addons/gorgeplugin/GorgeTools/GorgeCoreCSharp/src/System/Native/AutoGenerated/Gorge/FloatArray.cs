...
{
public partial class FloatArray : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("FloatArray", "Gorge", new GorgeType[]{});
...
metadata: global::Gorge.Native.Gorge.FloatArray.InjectorFieldMetadata_length()
),
},
annotations: global::Gorge.Native.Gorge.FloatArray.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 1,
floatCount: 0,
...
{
global::Gorge.Native.Gorge.FloatArray FloatArray;
if(gorgeObject is global::Gorge.Native.Gorge.FloatArray)
{
FloatArray = (global::Gorge.Native.Gorge.FloatArray) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
FloatArray = (global::Gorge.Native.Gorge.FloatArray) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.FloatReturn = FloatArray.Get(InvokeParameterPool.Int[0]);
break;
case 1:
FloatArray.Set(InvokeParameterPool.Int[0], InvokeParameterPool.Float[0]);
break;
default:
...
{
return global::Gorge.Native.Gorge.FloatArray.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.Gorge.FloatArray.Class.Declaration;
...
{
var injector = new global::Gorge.Native.Gorge.FloatArray.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.Gorge.FloatArray.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.Gorge.FloatArray FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.Gorge.FloatArray) u.NativeObject;
}
return (global::Gorge.Native.Gorge.FloatArray) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.Gorge.FloatArray ConstructInstance(Injector injector)
{
return new global::Gorge.Native.Gorge.FloatArray(injector);
}
/// <summary>
...
{
throw new Exception($"Gorge.FloatArray类Injector的length字段没有设置，且没有默认值");
}
else
{
