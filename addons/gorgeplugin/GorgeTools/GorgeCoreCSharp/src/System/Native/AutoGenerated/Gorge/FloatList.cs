...
{
public partial class FloatList : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("FloatList", "Gorge", new GorgeType[]{});
...
metadata: global::Gorge.Native.Gorge.FloatList.InjectorFieldMetadata_length()
),
},
annotations: global::Gorge.Native.Gorge.FloatList.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 1,
floatCount: 0,
...
{
global::Gorge.Native.Gorge.FloatList FloatList;
if(gorgeObject is global::Gorge.Native.Gorge.FloatList)
{
FloatList = (global::Gorge.Native.Gorge.FloatList) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
FloatList = (global::Gorge.Native.Gorge.FloatList) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.FloatReturn = FloatList.Get(InvokeParameterPool.Int[0]);
break;
case 1:
FloatList.Set(InvokeParameterPool.Int[0], InvokeParameterPool.Float[0]);
break;
case 2:
FloatList.Add(InvokeParameterPool.Float[0]);
break;
case 3:
FloatList.RemoveAt(InvokeParameterPool.Int[0]);
break;
default:
...
{
return global::Gorge.Native.Gorge.FloatList.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.Gorge.FloatList.Class.Declaration;
...
{
var injector = new global::Gorge.Native.Gorge.FloatList.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.Gorge.FloatList.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.Gorge.FloatList FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.Gorge.FloatList) u.NativeObject;
}
return (global::Gorge.Native.Gorge.FloatList) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.Gorge.FloatList ConstructInstance(Injector injector)
{
return new global::Gorge.Native.Gorge.FloatList(injector);
}
/// <summary>
...
{
throw new Exception($"Gorge.FloatList类Injector的length字段没有设置，且没有默认值");
}
else
{
