...
{
public partial class IntArray : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("IntArray", "Gorge", new GorgeType[]{});
...
metadata: global::Gorge.Native.Gorge.IntArray.InjectorFieldMetadata_length()
),
},
annotations: global::Gorge.Native.Gorge.IntArray.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 1,
floatCount: 0,
...
{
global::Gorge.Native.Gorge.IntArray IntArray;
if(gorgeObject is global::Gorge.Native.Gorge.IntArray)
{
IntArray = (global::Gorge.Native.Gorge.IntArray) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
IntArray = (global::Gorge.Native.Gorge.IntArray) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.IntReturn = IntArray.Get(InvokeParameterPool.Int[0]);
break;
case 1:
IntArray.Set(InvokeParameterPool.Int[0], InvokeParameterPool.Int[1]);
break;
default:
...
{
return global::Gorge.Native.Gorge.IntArray.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.Gorge.IntArray.Class.Declaration;
...
{
var injector = new global::Gorge.Native.Gorge.IntArray.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.Gorge.IntArray.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.Gorge.IntArray FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.Gorge.IntArray) u.NativeObject;
}
return (global::Gorge.Native.Gorge.IntArray) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.Gorge.IntArray ConstructInstance(Injector injector)
{
return new global::Gorge.Native.Gorge.IntArray(injector);
}
/// <summary>
...
{
throw new Exception($"Gorge.IntArray类Injector的length字段没有设置，且没有默认值");
}
else
{
