...
{
public partial class IntList : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("IntList", "Gorge", new GorgeType[]{});
...
metadata: global::Gorge.Native.Gorge.IntList.InjectorFieldMetadata_length()
),
},
annotations: global::Gorge.Native.Gorge.IntList.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 1,
floatCount: 0,
...
{
global::Gorge.Native.Gorge.IntList IntList;
if(gorgeObject is global::Gorge.Native.Gorge.IntList)
{
IntList = (global::Gorge.Native.Gorge.IntList) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
IntList = (global::Gorge.Native.Gorge.IntList) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.IntReturn = IntList.Get(InvokeParameterPool.Int[0]);
break;
case 1:
IntList.Set(InvokeParameterPool.Int[0], InvokeParameterPool.Int[1]);
break;
case 2:
IntList.Add(InvokeParameterPool.Int[0]);
break;
case 3:
IntList.RemoveAt(InvokeParameterPool.Int[0]);
break;
default:
...
{
return global::Gorge.Native.Gorge.IntList.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.Gorge.IntList.Class.Declaration;
...
{
var injector = new global::Gorge.Native.Gorge.IntList.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.Gorge.IntList.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.Gorge.IntList FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.Gorge.IntList) u.NativeObject;
}
return (global::Gorge.Native.Gorge.IntList) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.Gorge.IntList ConstructInstance(Injector injector)
{
return new global::Gorge.Native.Gorge.IntList(injector);
}
/// <summary>
...
{
throw new Exception($"Gorge.IntList类Injector的length字段没有设置，且没有默认值");
}
else
{
