...
{
public partial class BoolArray : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("BoolArray", "Gorge", new GorgeType[]{});
...
metadata: global::Gorge.Native.Gorge.BoolArray.InjectorFieldMetadata_length()
),
},
annotations: global::Gorge.Native.Gorge.BoolArray.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 1,
floatCount: 0,
...
{
global::Gorge.Native.Gorge.BoolArray BoolArray;
if(gorgeObject is global::Gorge.Native.Gorge.BoolArray)
{
BoolArray = (global::Gorge.Native.Gorge.BoolArray) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
BoolArray = (global::Gorge.Native.Gorge.BoolArray) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.BoolReturn = BoolArray.Get(InvokeParameterPool.Int[0]);
break;
case 1:
BoolArray.Set(InvokeParameterPool.Int[0], InvokeParameterPool.Bool[0]);
break;
default:
...
{
return global::Gorge.Native.Gorge.BoolArray.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.Gorge.BoolArray.Class.Declaration;
...
{
var injector = new global::Gorge.Native.Gorge.BoolArray.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.Gorge.BoolArray.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.Gorge.BoolArray FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.Gorge.BoolArray) u.NativeObject;
}
return (global::Gorge.Native.Gorge.BoolArray) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.Gorge.BoolArray ConstructInstance(Injector injector)
{
return new global::Gorge.Native.Gorge.BoolArray(injector);
}
/// <summary>
...
{
throw new Exception($"Gorge.BoolArray类Injector的length字段没有设置，且没有默认值");
}
else
{
