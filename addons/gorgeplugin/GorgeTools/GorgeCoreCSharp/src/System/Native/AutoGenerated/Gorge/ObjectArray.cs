...
{
public partial class ObjectArray : GorgeObject
{
public new class Implementation : GorgeClass
{
public static GorgeType Type() => GorgeType.Object("ObjectArray", "Gorge", new GorgeType[]{GorgeType.Generics("TItem")});
...
metadata: global::Gorge.Native.Gorge.ObjectArray.InjectorFieldMetadata_length()
),
},
annotations: global::Gorge.Native.Gorge.ObjectArray.ClassAnnotations(),
fieldIndexCount:
new TypeCount(
intCount: 1,
floatCount: 0,
...
{
global::Gorge.Native.Gorge.ObjectArray ObjectArray;
if(gorgeObject is global::Gorge.Native.Gorge.ObjectArray)
{
ObjectArray = (global::Gorge.Native.Gorge.ObjectArray) gorgeObject;
}
else if(gorgeObject is CompiledGorgeObject u)
{
ObjectArray = (global::Gorge.Native.Gorge.ObjectArray) u.NativeObject;
}
else
{
...
{
case 0:
InvokeParameterPool.ObjectReturn = ObjectArray.Get(InvokeParameterPool.Int[0]);
break;
case 1:
ObjectArray.Set(InvokeParameterPool.Int[0], (GorgeObject)InvokeParameterPool.Object[0]);
break;
default:
...
{
return global::Gorge.Native.Gorge.ObjectArray.ConstructInstance(injector);
}
break;
default:
...
{
public override ClassDeclaration InjectedClassDeclaration { get; } = global::Gorge.Native.Gorge.ObjectArray.Class.Declaration;
...
{
var injector = new global::Gorge.Native.Gorge.ObjectArray.SpecificInjector();
CloneTo(injector);
return injector;
}
public void CloneTo(global::Gorge.Native.Gorge.ObjectArray.SpecificInjector toInjector)
{
...
public new static global::Gorge.Native.Gorge.ObjectArray FromGorgeObject(GorgeObject gorgeObject)
{
if (gorgeObject is CompiledGorgeObject u)
{
return (global::Gorge.Native.Gorge.ObjectArray) u.NativeObject;
}
return (global::Gorge.Native.Gorge.ObjectArray) gorgeObject;
}
...
/// 0号构造方法对应的工厂方法
/// </summary>
public new static global::Gorge.Native.Gorge.ObjectArray ConstructInstance(Injector injector)
{
return new global::Gorge.Native.Gorge.ObjectArray(injector);
}
/// <summary>
...
{
throw new Exception($"Gorge.ObjectArray类Injector的length字段没有设置，且没有默认值");
}
else
{
